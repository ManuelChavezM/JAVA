package com.mani.appfacturas.domain;
...
public class Factura {
    ...
    //incremento automatico del folio
    ...
    public Factura(String descripcion, Cliente cliente) {
        ...
        this.folio = ++ultimoFolio; // se agrega la variable estatica con pre incremento para que empiece en 1
